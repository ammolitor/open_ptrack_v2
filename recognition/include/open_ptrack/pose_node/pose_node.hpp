 ...
 */
open_ptrack::pose_node::PoseNode(ros::NodeHandle& nh, std::string sensor_string, json zone):
...
void open_ptrack::pose_node::PoseNode::callback(const PointCloudT::ConstPtr& cloud_) {
