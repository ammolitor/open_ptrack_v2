 ...
 */
open_ptrack::detection_node::DetectionNode(ros::NodeHandle& nh, std::string sensor_string, json zone):
...
void open_ptrack::detection_node::DetectionNode::callback(const PointCloudT::ConstPtr& cloud_) {
