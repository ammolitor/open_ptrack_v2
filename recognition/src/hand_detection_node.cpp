 ...
 */
open_ptrack::hand_detection_node::HandDetectionNode(ros::NodeHandle& nh, std::string sensor_string, json zone):
...
void open_ptrack::hand_detection_node::HandDetectionNode::basic_callback(const PointCloudT::ConstPtr& cloud_) {
...
void open_ptrack::hand_detection_node::HandDetectionNode::callback(const PointCloudT::ConstPtr& cloud_) {
