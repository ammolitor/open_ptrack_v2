...
#ifndef OPEN_PTRACK_NODES_HAND_DETECTION_NODE_H_
#define OPEN_PTRACK_NODES_HAND_DETECTION_NODE_H_
...
#include <open_ptrack/nodes/hand_detection_node.hpp>
#endif /* OPEN_PTRACK_NODES_HAND_DETECTION_NODE_H_ */
